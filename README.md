* **Файлы с тестами**
* 1 Файл **tests_registration.py** содержит тесты на регистрацию: 
...
* 2 Файл **tests_sign_in_out.py** содержит тесты на проверку успешного выхода и входа через:
...
* 3 Файл **tests_transfer.py** содержит тесты на проверку успешного перехода:
...
* 4 Файл **tests_constructor.py** содержит тесты на проверку работоспособности переходов в разделе "Конструктор" к разделам:
